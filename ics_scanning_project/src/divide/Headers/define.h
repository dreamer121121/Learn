...
extern string weightfilename;
extern string curfilename;
extern vector<string>::iterator filenamesit;
extern string curhost;
extern int curport;
extern string curmessage;
extern map<string, double> weight;
extern int scadanum;
extern int ipcameranum;
extern int totalnum;
